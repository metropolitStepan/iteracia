...
int binarySearch(const vector<int>& indices, const string& key, const vector<Student>& students, bool byName) {
    int left = 0;
        ...
        try {
            ...
            switch (choice) {
                ...
                case 3: {
                    ...
                    int foundIndex = binarySearch(nameIndices, searchName, students, true);
                    if (foundIndex != -1) {
                ...
                case 4: {
                    ...
                    int foundIndex = binarySearch(scoreIndices, searchScore, students, false);
                    if (foundIndex != -1) {
                        cout << "Студент найден: " << students[foundIndex].name << " - " << students[foundIndex].score << endl;
                    } else {
